...
export default function Products({fontClassName}:{fontClassName:string}) {
  return (
    <div className="mb-16">
      ...
      <div
        ...
        <button className={"bg-orange w-fit p-2 px-6 font-extrabold mb-10 text-2xl " + fontClassName}>ORDER NOW</button>
      </div>
    </div>
  );
}
